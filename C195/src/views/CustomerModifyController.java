...
public class CustomerModifyController implements Initializable {
    ...
    //sets country based off of city selection
    @FXML
    ...
    //updates customerDB with modifications made after selecting modify customer button
    public boolean handleModifyCustomer() {
        ...
        if(!validateName(customerAllName)||!validateAddress(customerAllAddress)||!validateCity(customerAllCity)||
            ...
            return CustomerDB.updateCustomer(id, customerAllName, customerAllAddress, customerAllCity, customerAllZip, customerAllPhone);
        }
    }
    
 
    public void populateFields(CustomerAll customerAll) {
        id = customerAll.getCustomerAllId();
        name.setText(customerAll.getCustomerAllName());
        address.setText(customerAll.getCustomerAllAddress());
        city.getSelectionModel().select(customerAll.getCustomerAllCity());
        setCountry();
        zip.setText(customerAll.getCustomerAllZip());
        phone.setText(customerAll.getCustomerAllPhone());
    }
    ...
    //initalizes cities from above list
    @Override

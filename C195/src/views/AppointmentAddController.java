...
public class AppointmentAddController implements Initializable {
    ...
    //adds appointments - verifies appointment date based on local time and scheduled appointments in database
    //alerts on overlappint appointments
    ...
    //sets consultant location based on consultant selected
    @FXML

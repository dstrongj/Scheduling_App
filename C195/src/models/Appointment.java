...
public class Appointment {
    ...
    public StringProperty getAppointmentEnd() {
    ...
    public StringProperty getAppointmentStart() {
        DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S"); 
    ...
    public LocalDate getDateOnly() {
        ...
        else if(this.aptLocation.get().equals("Seattle")) {
            zid = ZoneId.of("America/Los_Angeles");
        }
        else if(this.aptLocation.get().equals("Los Angeles")){
            zid = ZoneId.of("America/Los_Angeles");
        }
        else if(this.aptLocation.get().equals("Denver")){
            zid = ZoneId.of("America/Phoenix");
        }
        else if(this.aptLocation.get().equals("Detriot")){
            zid = ZoneId.of("America/New_York");
        }
        else {
    ...
    public String getTimeOnly() {
        ...
        if(this.aptLocation.get().equals("New York")) {
            ...
            zdt = ts.toLocalDateTime().atZone(zid);
            lt = zdt.toLocalTime().minusHours(8);
        } else if(this.aptLocation.get().equals("Detroit")) {
            zid = ZoneId.of("America/New_York");
            zdt = ts.toLocalDateTime().atZone(zid);
            lt = zdt.toLocalTime().minusHours(4);
        }
